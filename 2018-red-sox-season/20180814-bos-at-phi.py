...
t1.new_ab()
t1.pitch_list("b f f f b f b f f s")
t1.out("K")
...
# 7. PHI #37 Odúbel Herrera (X - X - X)
b8.new_ab()
b8.pitch_list("f s b b f s")
b8.out("K")

# 8. PHI #38 Jorge Alfaro (X - X - X)
b8.new_ab()
b8.pitch_list("f b b b f f c")
b8.out("!K")
